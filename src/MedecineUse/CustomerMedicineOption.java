 ...
 */
public class CustomerMedicineOption extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        medicineTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                { new Integer(1), "Ceterizine 10Mg Tablet - RiteMed", "Cetirizne", "RiteMed",  new Integer(100),  new Float(20.75), "December 9, 2025", "December 9,2018", "Unique Pharmaceutical Laboratories"},
                { new Integer(2), "Allerta 10Mg Tablet", "Loratadine", "Allerta",  new Integer(100),  new Float(22.15), "December 9, 2025", "December 9,2018", "Amherst Laboratories, Inc."},
        ...
        if (medicineTable.getColumnModel().getColumnCount() > 0) {
            ...
            medicineTable.getColumnModel().getColumn(7).setResizable(false);
            medicineTable.getColumnModel().getColumn(7).setPreferredWidth(100);
            medicineTable.getColumnModel().getColumn(8).setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerMedicineOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerMedicineOption().setVisible(true);
            }
        });
    }
