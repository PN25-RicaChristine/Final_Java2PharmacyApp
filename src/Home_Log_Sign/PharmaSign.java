...
public class PharmaSign extends javax.swing.JFrame {
    ...
    //sign up function for pharma
    public void SignUp(Pharmacist p) {
        app.pharmacistList.add(p);
        int n = app.pharmacistList.indexOf(p);
        System.out.println(app.pharmacistList.get(n));
    }
