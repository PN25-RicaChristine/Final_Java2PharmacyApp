 ...
 */
public class CusViewOrders extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Java Pharmacy --- View Orders");
        jLabel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        MainContent.setBackground(new java.awt.Color(255, 255, 255));
        MainContent.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        orderIdTable.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        orderIdTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Order ID", "Order Date", "Required Date", "Amount", "Discounted(20%)", "TOTAL AMOUNT"
            }
        ) {
        ...
        orderIdTable.setAutoscrolls(false);
        orderIdTable.setGridColor(new java.awt.Color(153, 153, 153));
        orderIdTable.setSelectionBackground(new java.awt.Color(51, 51, 51));
        orderIdTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                orderIdTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(orderIdTable);
        if (orderIdTable.getColumnModel().getColumnCount() > 0) {
            orderIdTable.getColumnModel().getColumn(0).setPreferredWidth(100);
            orderIdTable.getColumnModel().getColumn(1).setPreferredWidth(100);
            orderIdTable.getColumnModel().getColumn(2).setPreferredWidth(100);
            orderIdTable.getColumnModel().getColumn(3).setPreferredWidth(100);
            orderIdTable.getColumnModel().getColumn(4).setPreferredWidth(30);
            orderIdTable.getColumnModel().getColumn(5).setPreferredWidth(100);
        }
        ...
        if (orderDetailsTable.getColumnModel().getColumnCount() > 0) {
            ...
            orderDetailsTable.getColumnModel().getColumn(3).setPreferredWidth(200);
        }
        ...
        IMessage.setBackground(new java.awt.Color(255, 255, 255));
        IMessage.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        IMessage.setForeground(new java.awt.Color(51, 51, 51));
    ...
    private void cancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) orderIdTable.getModel();
        if (orderIdTable.getSelectedRow() == -1) {
            if (orderIdTable.getRowCount() == 0) {
                IMessage.setText("Table is Empty.");
            } else {
                IMessage.setText("You must Selected a Product.");
            }
        } else {
            String id = model.getValueAt(orderIdTable.getSelectedRow(), 0).toString();
            od.cancelOrder(id);
            model.removeRow(orderIdTable.getSelectedRow());
...
//Remove rows one by one from the end of the table
    ...
    private void orderIdTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orderIdTableMouseClicked
...
//Remove rows one by one from the end of the table
        ...
        od.getOrderDetails(orderDetailsTable, model.getValueAt(orderIdTable.getSelectedRow(), 0).toString());

    }//GEN-LAST:event_orderIdTableMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CusViewOrders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CusViewOrders().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable orderIdTable;
